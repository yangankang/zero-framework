...
public class ASMDeserializerFactory implements Opcodes {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(com.yoosal.json.parser.JSONLexerBase.VALUE_NULL);
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.yoosal.json.asm.Type.getType(desc(itemClass)));
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.yoosal.json.parser.JSONToken.LBRACKET);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "nextToken", "(I)V");
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(com.yoosal.json.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(com.yoosal.json.parser.JSONLexerBase.END);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.yoosal.json.asm.Type.getType(desc(fieldClass))); // cast
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.yoosal.json.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.yoosal.json.parser.DefaultJSONParser.NONE);
